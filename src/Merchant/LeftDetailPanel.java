...
public class LeftDetailPanel extends DetailPanel {
	...
	private GUIElements.MyTextField typeTextField, nameTextField,
			rarityTextField;
	...
	public void receiveUpdate() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, typeTextField, EconomosGUI.smallPanelGap(), SpringLayout.SOUTH, iconPanel);
		...
		springLayout.putConstraint(SpringLayout.NORTH, nameTextField, EconomosGUI.smallPanelGap(), SpringLayout.SOUTH, typeTextField);
		...
		springLayout.putConstraint(SpringLayout.NORTH, rarityTextField, EconomosGUI.smallPanelGap(), SpringLayout.SOUTH, nameTextField);
