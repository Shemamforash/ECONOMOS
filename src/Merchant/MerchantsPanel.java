...
public class MerchantsPanel extends GUIElements.MyPanel implements UpdateListener {
	...
	public MerchantsPanel() {
		...
		guilds = new GuildPanel(new String[] { "Weaver", "Spicer", "Temperer", "Mercer", "Purifier", "Smelter", "Mason", "Crofter" }, EconomosGUI.screenHeight() - 50, EconomosGUI.screenWidth() / 4);
		add(guilds);
		...
		springLayout.putConstraint(SpringLayout.WEST, bodyPanel, EconomosGUI.largePanelGap(), SpringLayout.EAST, guilds);
		...
		sl_bodyPanel.putConstraint(SpringLayout.NORTH, resourceGraphPanel, EconomosGUI.largePanelGap(), SpringLayout.SOUTH, resourceDetailPanel);
	...
	public void receiveUpdate() {
		...
		springLayout.putConstraint(SpringLayout.EAST, guilds, (int) (EconomosGUI.screenWidth() / 4), SpringLayout.WEST, this);
		...
		springLayout.putConstraint(SpringLayout.WEST, centerDetailPanel, EconomosGUI.largePanelGap(), SpringLayout.EAST, leftDetailPanel);
		springLayout.putConstraint(SpringLayout.SOUTH, centerDetailPanel, 0, SpringLayout.SOUTH, resourceDetailPanel);
		springLayout.putConstraint(SpringLayout.EAST, centerDetailPanel, centerPanelWidth + EconomosGUI.largePanelGap(), SpringLayout.EAST, leftDetailPanel);

		springLayout.putConstraint(SpringLayout.NORTH, rightDetailPanel, 0, SpringLayout.NORTH, resourceDetailPanel);
		springLayout.putConstraint(SpringLayout.WEST, rightDetailPanel, EconomosGUI.largePanelGap(), SpringLayout.EAST, centerDetailPanel);
